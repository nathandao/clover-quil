...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([initial_state,p1__11220_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_11221 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_11222 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_11221);
var pos_11223 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_11221);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_11222);

var tr__11143__auto___11224 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_11222) - cljs.core.first(pos_11223)),(((quil.core.height() / (2)) / zoom_11222) - cljs.core.second(pos_11223))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__11143__auto___11224);
...
var G__11229 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__11230 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__11229,G__11230) : user_mouse_dragged.call(null,G__11229,G__11230));
...
return (function (state,event){
var G__11231 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__11232 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__11231,G__11232) : user_mouse_wheel.call(null,G__11231,G__11232));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
