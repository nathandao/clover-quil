...
var vec__10660 = axis;
var a_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10660,(0),null);
var a_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10660,(1),null);
var a_z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10660,(2),null);
var vec__10663 = v;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10663,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10663,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10663,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__10666,p__10667){
var vec__10674 = p__10666;
var u1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10674,(0),null);
var u2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10674,(1),null);
var u3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10674,(2),null);
var vec__10677 = p__10667;
...
var v3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10677,(2),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__10680_SHARP_){
return (p1__10680_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle(p1__10681_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud(quil.middlewares.navigation_3d.rotate_lr(p1__10682_SHARP_,angle_lr),angle_ud);
...
var map__10699 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10699__$1,cljs.core.cst$kw$up);
var straight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10699__$1,cljs.core.cst$kw$straight);
var temp__4655__auto__ = (function (){var pred__10701 = cljs.core._EQ_;
var expr__10702 = cljs.core.cst$kw$key.cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_((function (){var G__10704 = cljs.core.cst$kw$w;
var G__10705 = expr__10702;
return (pred__10701.cljs$core$IFn$_invoke$arity$2 ? pred__10701.cljs$core$IFn$_invoke$arity$2(G__10704,G__10705) : pred__10701.call(null,G__10704,G__10705));
})())){
return straight;
} else {
if(cljs.core.truth_((function (){var G__10706 = cljs.core.cst$kw$s;
var G__10707 = expr__10702;
return (pred__10701.cljs$core$IFn$_invoke$arity$2 ? pred__10701.cljs$core$IFn$_invoke$arity$2(G__10706,G__10707) : pred__10701.call(null,G__10706,G__10707));
})())){
return quil.middlewares.navigation_3d.v_opposite(straight);
} else {
if(cljs.core.truth_((pred__10701.cljs$core$IFn$_invoke$arity$2 ? pred__10701.cljs$core$IFn$_invoke$arity$2(quil.middlewares.navigation_3d.space,expr__10702) : pred__10701.call(null,quil.middlewares.navigation_3d.space,expr__10702)))){
return quil.middlewares.navigation_3d.v_opposite(up);
} else {
if(cljs.core.truth_((function (){var G__10708 = cljs.core.cst$kw$z;
var G__10709 = expr__10702;
return (pred__10701.cljs$core$IFn$_invoke$arity$2 ? pred__10701.cljs$core$IFn$_invoke$arity$2(G__10708,G__10709) : pred__10701.call(null,G__10708,G__10709));
})())){
return up;
} else {
if(cljs.core.truth_((function (){var G__10710 = cljs.core.cst$kw$d;
var G__10711 = expr__10702;
return (pred__10701.cljs$core$IFn$_invoke$arity$2 ? pred__10701.cljs$core$IFn$_invoke$arity$2(G__10710,G__10711) : pred__10701.call(null,G__10710,G__10711));
})())){
return quil.middlewares.navigation_3d.cross_product(straight,up);
} else {
if(cljs.core.truth_((function (){var G__10712 = cljs.core.cst$kw$a;
var G__10713 = expr__10702;
return (pred__10701.cljs$core$IFn$_invoke$arity$2 ? pred__10701.cljs$core$IFn$_invoke$arity$2(G__10712,G__10713) : pred__10701.call(null,G__10712,G__10713));
})())){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d,cljs.core.cst$kw$position], null),((function (dir,temp__4655__auto__,map__10699,map__10699__$1,up,straight){
return (function (p1__10683_SHARP_){
return quil.middlewares.navigation_3d.v_plus(p1__10683_SHARP_,quil.middlewares.navigation_3d.v_mult(dir,step_size));
});})(dir,temp__4655__auto__,map__10699,map__10699__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([initial_state,p1__10714_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var rotate_on_fn = (function (){var G__10732 = options;
var G__10733 = ((function (G__10732,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed){
return (function (state,_){
return state;
});})(G__10732,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed))
;
return (rotate_on.cljs$core$IFn$_invoke$arity$2 ? rotate_on.cljs$core$IFn$_invoke$arity$2(G__10732,G__10733) : rotate_on.call(null,G__10732,G__10733));
})();
...
var map__10734_10749 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__10734_10750__$1 = ((((!((map__10734_10749 == null)))?((((map__10734_10749.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10734_10749.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10734_10749):map__10734_10749);
var vec__10735_10751 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10734_10750__$1,cljs.core.cst$kw$straight);
var c_x_10752 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10735_10751,(0),null);
var c_y_10753 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10735_10751,(1),null);
var c_z_10754 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10735_10751,(2),null);
var vec__10738_10755 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10734_10750__$1,cljs.core.cst$kw$up);
var u_x_10756 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10738_10755,(0),null);
var u_y_10757 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10738_10755,(1),null);
var u_z_10758 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10738_10755,(2),null);
var vec__10741_10759 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10734_10750__$1,cljs.core.cst$kw$position);
var p_x_10760 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10741_10759,(0),null);
var p_y_10761 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10741_10759,(1),null);
var p_z_10762 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10741_10759,(2),null);
quil.core.camera.cljs$core$IFn$_invoke$arity$9(p_x_10760,p_y_10761,p_z_10762,(p_x_10760 + c_x_10752),(p_y_10761 + c_y_10753),(p_z_10762 + c_z_10754),u_x_10756,u_y_10757,u_z_10758);
...
var G__10745 = quil.middlewares.navigation_3d.move(state,event,step_size);
var G__10746 = event;
return (key_pressed.cljs$core$IFn$_invoke$arity$2 ? key_pressed.cljs$core$IFn$_invoke$arity$2(G__10745,G__10746) : key_pressed.call(null,G__10745,G__10746));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
,rotate_on,((function (user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup){
return (function (state,event){
var G__10747 = quil.middlewares.navigation_3d.rotate(state,event,pixels_in_360);
var G__10748 = event;
return (rotate_on_fn.cljs$core$IFn$_invoke$arity$2 ? rotate_on_fn.cljs$core$IFn$_invoke$arity$2(G__10747,G__10748) : rotate_on_fn.call(null,G__10747,G__10748));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
], 0));
});
